...
namespace Microsoft.Samples.Kinect.CoordinateMappingBasics
{
    ...
    {   
        ...
        /// <summary>
        /// Flag to save depth date and color image 
        /// </summary>
        public int flag = 0; 
        ...
        private void SensorAllFramesReady(object sender, AllFramesReadyEventArgs e)
        {
            ...
            if (true == depthReceived)
            {
                ...
                //to save the player depth in triple format
                if (flag == 1) {
                    string time = System.DateTime.Now.ToString("hh'-'mm'-'ss", CultureInfo.CurrentUICulture.DateTimeFormat);
                    string myPhotos = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures);
                    string path = Path.Combine(myPhotos, "DepthData-" + time + ".txt");
                    FileStream fs = new FileStream(path, FileMode.Create);
                    StreamWriter sw = new StreamWriter(fs);
                    string path1 = Path.Combine(myPhotos, "DepthDataInColor-" + time + ".txt");
                    ...
                    for (int y = 0; y < this.depthHeight; ++y)
                    {
                        for (int x = 0; x < this.depthWidth; ++x)
                        {
                            ...
                            if (player > 0) {
                            	int xx = x * this.colorToDepthDivisor;
                            	int yy = y * this.colorToDepthDivisor;
                                string data = y.ToString() + " " + x.ToString() + " " + depthPixel.Depth.ToString() + "\r\n";
                                string data1 = yy.ToString() + " " + xx.ToString() + " " + depthPixel.Depth.ToString() + "\r\n";
                                sw.Write(data); 
                                sw1.Write(data1);
                            }
                        }            
            ...
            if (true == colorReceived)
            {
                ...
                if (flag == 1)
                {
                    ...
                    encoder.Frames.Add(BitmapFrame.Create(this.playerOpacityMaskImage));
                    string time = System.DateTime.Now.ToString("hh'-'mm'-'ss", CultureInfo.CurrentUICulture.DateTimeFormat);
                    string myPhotos = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures);
                    string path = Path.Combine(myPhotos, "KinectSnapshotBlackWhite-" + time + ".png");
                    FileStream fs = new FileStream(path, FileMode.Create);
                    encoder.Save(fs);
                }
            }
        ...
        private void ButtonScreenshotClick(object sender, RoutedEventArgs e)
        {
            ...
            string path1 = Path.Combine(myPhotos, "FullColor-" + time + ".png");
